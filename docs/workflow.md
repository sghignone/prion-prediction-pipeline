...
1. Download fungal proteomes from UniProt Trembl fungi dataset (uniprot_trembl_fungi.dat.gz) to have a broad and high-quality starting point.

2. (optional) Extract proteomes of target species from metadata:
